...
def seed_users():
    ...
    venue1 = Venue(
        ...
        state="Illinois",
        city="Chicago",
        img_url="https://cdn.pixabay.com/photo/2016/11/29/12/54/bar-1869656_960_720.jpg",
        lat=41.859991,
        lng=-87.676378
    )
    ...
    venue2 = Venue(
        ...
        state="Idaho",
        city="Boise",
        img_url="https://cdn.pixabay.com/photo/2015/03/26/10/28/restaurant-691397_1280.jpg",
        lat=43.620665,
        lng=-116.232819
    )
    venue3 = Venue(
        ...
        state="Idaho",
        city="Boise",
        img_url="https://cdn.pixabay.com/photo/2017/01/26/02/06/platter-2009590_1280.jpg",
        lat=43.611906,
        lng=-116.198984
    )
    venue4 = Venue(
        ...
        state="Illinois",
        city="Chicago",
        img_url="https://cdn.pixabay.com/photo/2020/06/30/15/03/table-5356682_1280.jpg",
        lat=41.803698,
        lng=-87.690396
    )
    venue5 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2013/11/12/01/29/bar-209148_1280.jpg",
        lat=41.468082,
        lng=-87.680034
    )
    venue6 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2015/05/15/14/55/cafe-768771_1280.jpg",
        lat=41.468082,
        lng=-87.980034
    )
    venue7 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2015/04/20/13/43/illumination-731494_1280.jpg",
        lat=41.498089,
        lng=-87.980034
    )
    venue8 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2016/11/21/16/02/bar-1846137_1280.jpg",
        lat=42.498089,
        lng=-86.980034
    )
    venue9 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2016/11/18/22/21/architecture-1837150_1280.jpg",
        lat=43.998089,
        lng=-87.710034
    )
    venue10 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2015/09/02/12/35/bar-918541_1280.jpg",
        lat=44.998089,
        lng=-86.710034
    )
    venue11 = Venue(
    ...
    venue12 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2015/07/02/10/27/bar-828768_1280.jpg",
        lat=41.169089,
        lng=-87.790034
    )
    venue13 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2016/10/16/21/13/drinks-1746272_1280.jpg",
        lat=41.559089,
        lng=-87.190034
    )
    venue14 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2018/09/04/02/13/pool-bar-3652849_1280.jpg",
        lat=42.559089,
        lng=-88.190034
    )
    venue15 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2015/03/26/09/42/breakfast-690128_1280.jpg",
        lat=44.559089,
        lng=-86.190034
    )
    venue16 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2017/08/17/00/26/breakfast-2649620_1280.jpg",
        lat=43.559089,
        lng=-86.190034
    )
    venue17 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2017/08/07/11/14/restaurant-2602736_1280.jpg",
        lat=40.559089,
        lng=-86.190034
    )
    venue18 = Venue(
        ...
        state="Chicago",
        city="Illinois",
        img_url="https://cdn.pixabay.com/photo/2017/03/27/14/21/chairs-2179044_1280.jpg",
        lat=40.559089,
        lng=-80.190034
    )
